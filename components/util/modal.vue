    ...
    <transition name="modal">
      ...
      <div class="modal-mask" v-if="isActive">
        <div class="modal-wrapper">
          <div class="modal-container mb-parent my-modal" :class="cssClass">
            <!-- title -->
            <div
              class="modal-header py-4 d-flex justify-content-between"
              v-if="title !== ''"
            >
              <h5 class="title small dark modal-title kudi-h4-popup">
                {{ title }}
              </h5>
              <button
                type="button"
            ...
            <div class="modal-body" ref="modalBox">
              <div
                class="position-absolute top-0 end-0 mt-3 me-2"
                v-if="title == ''"
              >
                <button
                  type="button"
            ...
            <div class="footer my-footer" v-if="hasFooter">
              <slot name="footer" />
            </div>
          </div>
        </div>
