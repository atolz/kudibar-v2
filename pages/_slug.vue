...
export default {
  ...
  head() {
    return {
      title:
        this.$helper.ucFirst(this.title) + " - Kudibar" ||
        "Page not available" + " - Kudibar",
      meta: [
        {
          hid: "description",
          name: "description",
          content: this.$helper.str_limit(
            this.desc || "Page not available",
            150
          ),
        },
        {
          ...
          name: "twitter:card",
          content: `${
            this.$helper.ucFirst(this.title) || "Event removed"
          } - Kudibar`,
        },
        {
          hid: "twitter:title",
